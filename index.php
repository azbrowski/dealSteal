<?php
	...
	if (!isset($_SESSION['user_id']))
		include RESOURCE_PATH . '/pop-out-register.php';
	include RESOURCE_PATH . '/popular.php';		
?>

<div class="container">

	<?php include RESOURCE_PATH . '/search-panel.php'; ?>
...
function searchFilter() {
	...
	$.ajax({
		url: "ajax/get-promotions-data.php",
		type: "GET",
		data: $.param(params),
		success: function(result){
			$(".result-holder").html(result);
		}
	});	
}
